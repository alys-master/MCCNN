...
def xconv(pts, fts, qrs, tag, N, K, D, P, C, C_pts_fts, is_training, with_X_transformation, depth_multiplier,
          sorting_method=None, with_global=True):
    ...
    if with_X_transformation:
        ...
        X_0_1 = pf.conv2d2(nn_pts_local, K * K, tag + 'X_0_1', is_training, (1, K))
        X_0_2 = pf.conv2d3(nn_pts_local, K * K, tag + 'X_0_2', is_training, (1, K))
